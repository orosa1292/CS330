...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		"../../Utilities/textures/black_wood_floor.jpg",
		"floor");

	bReturn = CreateGLTexture(
		"../../Utilities/textures/black_stone.jpg",
		"table lower");
	...
	bReturn = CreateGLTexture(
		"../../Utilities/textures/cigar_box.jpg",
		"cigar box");
...
void SceneManager::DefineObjectMaterials()
{
	...
	woodMaterial.ambientColor = glm::vec3(0.4f, 0.3f, 0.1);
	...
	OBJECT_MATERIAL blackstoneMaterial;
	blackstoneMaterial.ambientColor = glm::vec3(0.4f, 0.4f, 0.4f);
	blackstoneMaterial.ambientStrength = 0.3f;
	blackstoneMaterial.diffuseColor = glm::vec3(0.3f, 0.3f, 0.3f);
	blackstoneMaterial.specularColor = glm::vec3(0.6f, 0.6f, 0.6f);
	blackstoneMaterial.shininess = 25.0;
	blackstoneMaterial.tag = "blackstone";

	m_objectMaterials.push_back(blackstoneMaterial);
	...
	marbleMaterial.ambientColor = glm::vec3(0.4f, 0.4f, 0.4f);
	marbleMaterial.ambientStrength = 0.3f;
	marbleMaterial.diffuseColor = glm::vec3(0.3f, 0.3f, 0.3f);
	marbleMaterial.specularColor = glm::vec3(0.6f, 0.6f, 0.6f);
	marbleMaterial.shininess = 85.0;
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].position", -4.5f, 11.0f, 0.0f);
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.68f, 0.67f, 0.67f);
	...
	m_pShaderManager->setFloatValue("lightSources[0].specularIntensity", 0.65f);

	m_pShaderManager->setVec3Value("lightSources[1].position", 4.5f, 11.0f, 0.0f);
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 0.68f, 0.67f, 0.67f);
	...
	m_pShaderManager->setVec3Value("lightSources[2].ambientColor", 0.68f, 0.67f, 0.67f);
	...
	m_pShaderManager->setVec3Value("lightSources[3].position", 0.0f, 11.0f, -5.5f);
	m_pShaderManager->setVec3Value("lightSources[3].ambientColor", 0.68f, 0.67f, 0.67f);
 ...
 *  RenderPlane()
 *
 *  This method is called to render the shapes for the plane
 *  object.
 ***********************************************************/
...
void SceneManager::RenderTable()
{
	...
	/*** Set needed transformations before drawing the basic mesh ***/
    //Code for the Sphere mesh one
	scaleXYZ = glm::vec3(2.5f, 1.55f, 2.5f);
	...
	//SetShaderColor(1, 0.7, 0.5, 0.7);
	SetShaderTexture("table lower");
	SetShaderMaterial("blackstone");
	// draw the mesh with transformation values
	m_basicMeshes->DrawHalfSphereMesh();
	/****************************************************************/
	//Code for the Sphere mesh two
	...
	scaleXYZ = glm::vec3(5.60f, 0.5f, 5.60f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 2.90f, 0.0f);
	...
	// set the color values into the shader
	//SetShaderColor(0.7, 0.7, 0.5, 0.7);
	SetShaderTexture("table surface side");
	...
	SetShaderTexture("table surface top");
	SetTextureUVScale(1.0, 1.0);
	SetShaderMaterial("marble");

	m_basicMeshes->DrawCylinderMesh(true, false, false);
	//**************************************************************/
	//Code for the torus mesh
	scaleXYZ = glm::vec3(5.25f, 5.25f, 1.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 3.10f, 0.0f);
	...
	// set the color values into the shader
	//SetShaderColor(0.203, 0.596, 1, 0.858);
	SetShaderTexture("table lip");
	SetShaderMaterial("blackstone");
 ...
 *  RenderGlassCup()
 *
 *  This method is called to render the shapes for the glass cup
 *  object.
 ***********************************************************/
void SceneManager::RenderGlassCup()
{
	// declare the variables for the transformations
	glm::vec3 scaleXYZ;
	float XrotationDegrees = 0.0f;
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.0f, 3.41f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.0f, 3.44f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.0f, 3.5f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.0f, 5.4f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.0f, 6.18f, 1.0f);
	...
	SetShaderColor(0.55, 0.1, 0.13, 0.41);
	SetShaderMaterial("glass");
	 ...
	 *  RenderGlassCup()
	 *
	 *  This method is called to render the shapes for the second glass cup
	 *  object.
	 ***********************************************************/
void SceneManager::RenderGlassCup2()
{
	// declare the variables for the transformations
	glm::vec3 scaleXYZ;
	float XrotationDegrees = 0.0f;
...
void SceneManager::RenderBottle()
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 3.65f, -3.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 3.64f, -3.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 7.48f, -3.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 7.47f, -3.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(.30f, .30f, 0.4f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 9.5f, -3.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 7.6f, -3.0f);
 ...
 *  RenderCigarBox()
 *
 *  This method is called to render the shapes for the cigar box
 *  object.
 ***********************************************************/
void SceneManager::RenderCigarBox()
{
	// declare the variables for the transformations
	glm::vec3 scaleXYZ;
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(2.15f, 0.45f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 3.53f, 3.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 3.95f, 3.0f);
	...
	//SetShaderColor(1, 1, 1, 1);
	SetShaderTexture("cigar box top");
	SetShaderMaterial("wood");
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.75f, 0.15f, 0.02f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 3.75f, 2.5f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.01f, 1.74f, 0.01f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.87f, 3.75f, 2.48f);
